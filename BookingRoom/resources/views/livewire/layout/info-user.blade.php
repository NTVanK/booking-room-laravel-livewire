<div class="container mt-5">
    <div class="d-flex align-items-center justify-content-between">
        <h4>Thông tin cá nhân khách hàng</h4>
        <a href="{{ route('logoutUser') }}" class="btn btn-danger">Đăng xuất</a>
    </div>
    ...
    <div class="container">
        ...
        <label class="form-label fw-bold" for='info'>Thông tin khách hàng</label>
        <table id="info" class="table table-bordered rounded overflow-hidden">
            ...
            <tbody>
                <tr class="text-center">
                    ...
                    <td>
                        @if ($event)
                            <button class="btn btn-primary" wire:click='change'>Sửa thông tin</button>
                        @else
                            <button class="btn btn-success" wire:click='save'>Lưu thông tin</button>
                            <button class="btn btn-danger" wire:click='change'>
        ...
        <hr>
        <label class="form-label fw-bold" for='history'>Thông tin khách hàng</label>
        <table class="table table-bordered rounded overflow-hidden" id="history">
            <thead class="table-dark">
                <tr class="text-center">
                    <th>Khách hàng</th>
                    <th>Số điện thoại</th>
